...
class SeleniumDriver():
    ...
    def findElement(self, locator):
        ...
        try:
            ...
            self.cl.info(
                "Element :: " + str(element) + "found for locator :: " + str(locator["locatorValue"]))
    ...
    def findElements(self, locator):
        element = []
        try:
            element = self.driver.find_elements(locator["type"],locator["value"])
            self.cl.info("Element :: " + str(element) + "found for locator :: " +  str(locator))

        except Exception as e:
            self.cl.info(
                "Element could not be found for :: " + str(locator))
            print_stack()
        return element
    ...
    def elementSend(self, locator, message):
        try:
            ...
            self.cl.info("Unable to send the message on locator: " + str(locator["locatorValue"]) + "Exception :: " + str(e))
            print_stack()
    ...
    def getText(self, locator):
        ...
        try:
            ...
            self.cl.info(
                "Unable to find the text for element : " + str(locator["locatorValue"]) + ". Following Exception occured :: " + str(e))
            print_stack()
        return element_text
    ...
    def getAttribute(self, locator, attributeType):
        ...
        try:
            ...
            self.cl.info(
                "Unable to find the value of attribute for element : " + str(locator["locatorValue"]) + ". Following exception occurred :: " + str(
                    e))
            print_stack()
        return elementAttribute
    ...
    def getAttributelist(self, locator, attributeType):
        ...
        try:
            ...
            self.cl.info("Unable to find the value of attribute for element : " + str(locator["locatorValue"]) + " exception :: " + str(e))
            print_stack()
        return element_attribute
    ...
    def explicitwait(self, locator, time, poll):
        try:
            ...
            self.cl.info("Waiting to click on element : " + str(locator["locatorValue"]) + "for time " + str(time) + "sec")
    ...
    def explicit_wait_for_iframe(self, locator, index, time, poll):
        try:
            ...
            self.cl.info("Waiting to find : " + str(locator["locatorValue"]) + "with index position:: " + str(index) + "for time " + str(
                time) + "sec")
            element = wait.until(
    ...
    def elementSendSpecial(self, locator, message):
        try:
            ...
            self.cl.info(
                "Unable to send the message on locator: " + str(locator["locatorValue"]) + ". Following Exception occurred :: " + str(e))
            print_stack()
